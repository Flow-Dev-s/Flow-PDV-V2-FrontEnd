            ...
            <tbody className="divide-y divide-slate-100">
              {filteredProducts.map(p => (
                <tr key={p.id} className="hover:bg-slate-50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-slate-500">R$ {(p.costPrice || 0).toFixed(2)}</td>
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden flex flex-col animate-in zoom-in-95">
            ...
            <form onSubmit={handleAddProduct}>
              <div className="p-6 space-y-4">
                ...
                {/* Grid para Código de Barras e Categoria */}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <select
                        ...
                        className="pl-10 w-full rounded-xl border border-slate-200 px-4 py-2.5 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all appearance-none bg-white"
                      >
                        <option value="" disabled>Selecione a categoria...</option>
                        {categories
                          .filter((cat) => cat !== 'Geral (Todas)') // Esconde a opção geral na hora de cadastrar
                          .map((cat) => (
