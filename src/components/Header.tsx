...
import { ShoppingCart, Settings, Package, Clock, LogOut, UserCircle, ClipboardList, Users } from 'lucide-react'
...
export function Header({ activeTab, onTabChange, user, onLogout, setShowSettings }: HeaderProps) {
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center px-4 h-16">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="px-8 py-5 font-semibold flex items-center gap-2 transition-all text-slate-500 hover:text-slate-900 hover:bg-slate-50 transition-colors flex items-center gap-2 px-6 font-medium cursor-pointer"
          >
          <Settings size={20} />
